...
class LyricsWindow(Gtk.Window):
	...
	def __init__(self, type):
		...
		self.lyrics_vbox.pack_start(self.lyrics, True, True, 5)
	...
	def get_spotify_song_data(self):
		...
		try:
			...
			return {'title':"Budapest", 'artist':"George Ezra",
					'artUrl':"https://open.spotify.com/image/191168d7b8c69c33910d65116c7b0315e38b5e6c" }
